...
registerBlockType( 'gutengridmasonry/post-grid', {
	...
	description: __( 'An advanced block that allows displaying post types based on different query parameters and visual configurations.', 'gutengridmasonry' ),
